...
var checkNumInputs = function checkNumInputs(selector) {
  var numInputs = document.querySelectorAll(selector); // Простая валидация ИНПУТОВ.
  ...
  */
  ...
  form.forEach(function (item) {
    ...
    item.addEventListener('submit', function (e) {
      e.preventDefault(); // Создаем БЛОК, в котором будем показывать процесс отправки
...
var images = function images() {
  ...
  workSection.addEventListener('click', function (e) {
    e.preventDefault();
    var target = e.target; // Проверяем наличеие сласса при помощи .contains()
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        if (e.target) {
          // Отключаем обработку действий по умолчанию.
          // Для ссылок отключается переход по href="#"
          e.preventDefault();
        }
  ...
  function calcScroll() {
    ...
    var scrolWidtn = div.offsetWidth - div.clientWidth;
    div.remove();
    return scrolWidtn;
  }
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  hideTabContent();
  showTabContent(); // Навешиваем обработчик на общую область, где будет произведен КЛИК
  // т.е. на шапку ТАБОВ

  header.addEventListener('click', function (e) {
    var target = e.target; // Определяем куда именно был произведен КЛИК. Делегирование событий.
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemining = function getTimeRemining(endTime) {
